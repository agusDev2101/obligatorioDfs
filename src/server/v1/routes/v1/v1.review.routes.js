...
import { validateCreateReview, validatePatchReview, validatePutReview} from "../../middleware/review.validate.middleware.js";
...
v1ReviewsRoutes.put("/:id", validatePutReview, putReviewByIdController)
v1ReviewsRoutes.patch("/:id", validatePatchReview, patchReviewByIdController)
